<template>
  <div id="main-container">
    <div id="calculator-container">
      <p class="result-history">
        {{
          calculations[calculations.length - 1].firstNumber +
          " " +
          calculations[calculations.length - 1].operator +
          " " +
          calculations[calculations.length - 1].secondNumber +
          " = " +
          calculations[calculations.length - 1].answer
        }}
      </p>
      ...
      <div id="top-button-section">
        <!-- First button row -->
        <button
          class="calculator-button number-button"
      ...
      <div id="button-grid">
        ...
        <button
          class="calculator-button number-button"
          @click="this.appendToDisplay('1')"
        >
          1
        </button>
        <button
          class="calculator-button number-button"
          @click="this.appendToDisplay('2')"
        >
          2
        </button>
        <button
          class="calculator-button number-button"
          @click="this.appendToDisplay('3')"
        >
          3
        </button>
        ...
        <button
          class="calculator-button number-button"
          @click="this.appendToDisplay('4')"
        >
          4
        </button>
        <button
          class="calculator-button number-button"
          @click="this.appendToDisplay('5')"
        >
          5
        </button>
        <button
          class="calculator-button number-button"
          @click="this.appendToDisplay('6')"
        >
          6
        </button>
        <button
        ...
        <button
          class="calculator-button number-button"
          @click="this.appendToDisplay('7')"
        >
          7
        </button>
        <button
          class="calculator-button number-button"
          @click="this.appendToDisplay('8')"
        >
          8
        </button>
        <button
          class="calculator-button number-button"
          @click="this.appendToDisplay('9')"
        >
          9
        </button>
        <button
        ...
        <button
          class="calculator-button operation-button"
          @click="this.invertDisplayValue"
        >
          +/-
        </button>
        <button
          class="calculator-button number-button"
          @click="this.appendToDisplay('0')"
        >
          0
        </button>
        <button
          class="calculator-button operation-button"
          @click="this.appendToDisplay('.')"
        >
          .
        </button>
        <button
